package com.example.bfn.ui.profil
...
class ProfilFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val profileSettingsBTN = root.findViewById<Button>(R.id.profile_settings_btn)
        ...
        val resetPassBtn = root.findViewById<Button>(R.id.profile_reset_pass_btn)
        ...
        nom_prenom = root.findViewById<TextView>(R.id.nom_prenom_tvv)
        picture = root.findViewById<ImageView>(R.id.profile_picture_ivv)
                ...
                override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                    if (response.isSuccessful && response.body() != null) {
                        ...
                        if(response.code() == 200)
                        {
                            ...
                            UserSession.img = content.get("img").asString
    ...
    private fun chooseImageCamera(){
        ...
        val providerFile = activity?.let { FileProvider.getUriForFile(it,"com.example.bfn.fileprovider", filePhoto) }
